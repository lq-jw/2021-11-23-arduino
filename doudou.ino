...
//const char* event = "doudou";  //IFTTT事件名稱
//const char* apiKey = "d1r7Y1qRgNr9EgJlRhAnIR";  //IFTTT Applet keyconst char* host = "maker.ifttt.com"; //IFTTT server網址
...
void ClientRequest(String value1, String value2, String value3){
  ...
  const char* event = "doudou";  //IFTTT事件名稱
  const char* apiKey = "d1r7Y1qRgNr9EgJlRhAnIR";  //IFTTT Applet key
  WiFiClient client;  //建立Client物件
  const int httpPort = 80;  //預設通訊阜80
  String JsonString = "";  //此範例不會用到
